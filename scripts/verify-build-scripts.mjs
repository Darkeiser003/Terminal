...
const checks = [
    ...
    ['Linux y Windows rechazan informes E2E parciales', files.linux.includes('verify-e2e-report.mjs') && files.windows.includes('verify-e2e-report.mjs') && files.e2eReport.includes('pestañas, división y redimensionado') && files.e2eReport.includes('showQuickActions')],
