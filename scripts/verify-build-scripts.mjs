...
const checks = [
    ...
    ['El build obtiene ConPTY desde un paquete oficial fijado y verifica SHA-512/ZIP antes de instalarlo', files.conptyPrepare.includes('Microsoft.Windows.Console.ConPTY') && files.conptyPrepare.includes('1.24.260710001') && files.conptyPrepare.includes('verifyNugetSha512') && files.conptyPrepare.includes('extractConptyAssets')],
