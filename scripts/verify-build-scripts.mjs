...
const checks = [
    ...
    ['Windows ejecuta tests ampliados por defecto en modo no interactivo', files.windows.includes('$runExtendedTests') && files.windows.includes('$NonInteractive') && files.windows.includes('Modo no interactivo')],
