...
const checks = [
    ...
    ['Windows ofrece comprobaciones externas offline sin saltar tests locales', files.windows.includes('$AllowOfflineChecks') && files.windows.includes("$env:LTERMINAL_LINK_CHECK = 'warn'") && files.windows.includes("$env:LTERMINAL_INSTALL_SOURCE_CHECK = 'warn'")],
