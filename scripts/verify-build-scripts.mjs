...
const checks = [
    ...
    ['El comando de release Windows ejecuta la batería completa', files.package.includes('dist:win') && files.package.includes('-FullTests') && files.package.includes('-InstallE2eDriver')],
    ['Windows conserva una ruta rápida explícita', files.package.includes('dist:win:fast') && files.package.includes('windows/build.ps1 -NoRun -NonInteractive')],
