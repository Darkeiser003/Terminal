...
/** Devuelve false mientras la PTY de esta pestaña aún está arrancando. */
export const markFrontendReady = (tabId: string) => tauriInvoke<boolean>('frontend_ready', { tabId });
